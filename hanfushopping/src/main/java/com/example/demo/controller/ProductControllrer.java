...
public @ResponseBody Result<PageSet<Product>> queryPage(String code,
		String name, String sort, @RequestParam long pageNum, @RequestParam int pageSize) {
